...
public class Residence {
	...
	public void infoFull() {
		System.out.println("Yerden Isýtma : "+(this.floorHeating==true?"VAR":"YOK"));
	}
/*
 hepsiburada projesinde, ayakkabý,tsört,TV,Laptop classlarýný
 oluþturunuz, 4 ertane kayýt giriniz ve gerekli iþlemleri yazýnýz
